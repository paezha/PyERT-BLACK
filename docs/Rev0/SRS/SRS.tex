...
\begin{itemize}
    ...
    \item \textcolor{red}{The project assumes the users have Python of version 3.8.15 installed on their computers.}

    \item \textcolor{red}{The project assumes the users will use the product on Windows or MacOS operating system.}
\end{itemize}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.75]{Use_Case_Diagram_old.png}
    %\caption{\bf Use Case Diagram}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.75,,cfbox=red 1pt 1pt]{Use_Case_Diagram_new.png}
    \caption{\bf \textcolor{red}{\sout{Use Case Diagram} Updated Use Case Diagram}}
\end{figure}
...
\begin{boxed}
\begin{tabular}{l r r}
 \color{red} \refstepcounter{reqnum} \reqthereqnum \label{Req3} Requirement Removed & \color{red}\sout{\textbf{Req. Type:}} &  \color{red}\sout{Functional}\\
\end{tabular}
\newline
\begin{tabular}{l p{11.5cm}}
...
\begin{boxed}
\begin{tabular}{l r r}
\refstepcounter{reqnum} \reqthereqnum \label{Req13} & {\bf Req. Type}: &  Functional\\
\end{tabular}
\newline
\begin{tabular}{l p{11.5cm}}
    {\bf Description:} & The product shall hall be able to read data from OSM PBF file.  \\
    {\bf Rationale:} & To match the input GPS data onto transportation network, the geographic data will be needed. The product shall be able to take OSM PBF file as its input which contains the needed geographic data, if the user has the geographic data stored locally. \\
    {\bf Organizer:} & Software Engineer\\
    {\bf Fit Criterion:} & After the user executes the product with valid input geographic data in OSM PBF file and optional boundary values of longitudes and latitudes, the product will be able to
    read the geographic data that is within the boundary from the input \\
\end{tabular}
\begin{tabular}{l r}
{\bf Costumer Satisfaction:} N/A &  {\bf Costumer Dissatisfaction:}  N/A\\
\end{tabular}
...
\begin{boxed}
\begin{tabular}{l r r}
\refstepcounter{reqnum} \reqthereqnum \label{Req14} & {\bf Req. Type}: &  Functional\\
\end{tabular}
\newline
\begin{tabular}{l p{11.5cm}}
    {\bf Description:} & The product shall hall be able to extract data from OSM API.  \\
    {\bf Rationale:} & OSM is a free, open geographic database. Being able to extract data from its API makes the user does not have to have network data stored locally when using the product. \\
    {\bf Organizer:} & Software Engineer\\
    {\bf Fit Criterion:} & Given boundary values of longitudes and latitudes, the product will be able to extract geographic data within the boundary.\\
\end{tabular}
\begin{tabular}{l r}
{\bf Costumer Satisfaction:} N/A &  {\bf Costumer Dissatisfaction:}  N/A\\
\end{tabular}
...
\begin{boxed}
\begin{tabular}{l r r}
\refstepcounter{reqnum} \reqthereqnum \label{Req15} & {\bf Req. Type}: &  Functional\\
\end{tabular}
\newline
\begin{tabular}{l p{11.5cm}}
    {\bf Description:} & The product shall be able to generate CSV and SHP files.  \\
    {\bf Rationale:} & Since the product is a re-implemented version of the GERT toolkit, it shall be able to generate the same type of files the GERT toolkit used to generate as its outputs. \\
    {\bf Organizer:} & Software Engineer\\
    {\bf Fit Criterion:} & After the user executes the product and processing the input data, the product will be able to generate required CSV and SHP files that contain the additional information of activity locations, information about the route choice generated, and the values of RCA variables.\\
\end{tabular}
\begin{tabular}{l r}
{\bf Costumer Satisfaction:} N/A &  {\bf Costumer Dissatisfaction:}  N/A\\
\end{tabular}
...
\hline
 & LF\ref{LF1} & LF\ref{LF2} & UH\ref{UH1} & UH\ref{UH2} & UH\ref{UH3} & PR\ref{PR1} & \color{red}\sout{PR\ref{PR2}} & PR\ref{PR3} & OE\ref{OE1} & OE\ref{OE2} & OE\ref{OE3} \\
\hline
\reqref{Req1} &  &  & & & & & & & & & \\
\hline
\reqref{Req2} &  &  & & & & & & & & & \\
\hline
\color{red}\sout{\reqref{Req3}} &  &  & & & & & \color{red}\sout{$\times$}  & & & & \\
\hline
\reqref{Req4} &  &  & & & & & & & & & \\
\hline
\reqref{Req5} &  &  & & & & & & & & & \\
\hline
\reqref{Req6} &  & & & & & & \color{red}\sout{$\times$} & & & & \\
\hline
\reqref{Req7} &  & & & & & & & & & & \\
\hline
\reqref{Req8} &  & & & & & & & & & & \\
...
\reqref{Req10} &  & & & & & & & & & & \\
\hline
\color{red}{\reqref{Req11}} &  & & & & & & & & & & \\
\hline
\color{red}{\reqref{Req12}} &  & & & & & & & & & & \\
\hline
\color{red}{\reqref{Req13}} &  & & & & & & & & & & \\
\hline
\color{red}{\reqref{Req14}} &  & & & & & & & & & & \\
\hline
\color{red}{\reqref{Req15}} &  & & & & & & & & & & \\
\hline
\end{tabular}
